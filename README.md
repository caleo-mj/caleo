...
- **Habit:** The app is designed to be used daily in order to achieve a user-specified daily calorie goal. However, a user can use the app just to check the calorie content of a specific food item as often or unoften as they want.
...
- [x] User can view their daily intake, their goal, and the remaining calories to achieve their goal.
...
* Gamify the experience: user makes weekly streaks when they achieve their goal.
